...
if __name__ == '__main__':
    ...
    for features in features_list:
        ...
        try:
            ...
            regi = features['regions_sites_udf']['name']
        ...
        # Store data in list
        f_data.append(
            [features['id'], features['name'], features['creation_time'], features['owner']['full_name'], regi, prio])

    # Insert data into database
    with oracledb.connect(db_address) as connection:
        with connection.cursor() as cursor:
            for i in f_data:
                cursor.execute("INSERT INTO AA_OCTANE_HIST VALUES(:1, :2, :3, :4, :5, :6)",
